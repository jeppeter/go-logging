...
// to replace logger
func SetRootLogger(l *Logger) *Logger {
	var retlogger *Logger
	retlogger = root_logger
	root_logger = l
	return retlogger
}
...
func Fatal(args ...interface{}) {
	...
	root_logger.log(CRITICAL, nil, args...)
	os.Exit(1)
}
...
func Fatalf(format string, args ...interface{}) {
	...
	root_logger.log(CRITICAL, &format, args...)
	os.Exit(1)
}
...
func Error(args ...interface{}) {
	...
	root_logger.log(ERROR, nil, args...)
}
...
func Errorf(format string, args ...interface{}) {
	...
	root_logger.log(ERROR, &format, args...)
}
...
func Warning(args ...interface{}) {
	...
	root_logger.log(WARNING, nil, args...)
}
...
func Warningf(format string, args ...interface{}) {
	...
	root_logger.log(WARNING, &format, args...)
}
...
func Notice(args ...interface{}) {
	...
	root_logger.log(NOTICE, nil, args...)
}
...
func Noticef(format string, args ...interface{}) {
	...
	root_logger.log(NOTICE, &format, args...)
}
...
func Infof(format string, args ...interface{}) {
	...
	root_logger.log(INFO, &format, args...)
}
...
func Debug(args ...interface{}) {
	...
	root_logger.log(DEBUG, nil, args...)
}
...
func Debugf(format string, args ...interface{}) {
	...
	root_logger.log(DEBUG, &format, args...)
}
